  ...
  return (
    <div>
      ...
      <section className="container mx-auto px-4 py-16 space-y-12">
        <div>
          <h2 className="text-2xl font-bold mb-4">Un sol à votre image</h2>
          <p className="text-darkGray max-w-3xl">
            Nous réalisons la pose de tous types de sols pour sublimer votre intérieur et répondre à vos contraintes
            techniques. Confiez-nous votre projet pour un rendu impeccable et durable.
          </p>
        </div>
