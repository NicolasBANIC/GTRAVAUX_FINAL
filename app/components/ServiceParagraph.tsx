        ...
        >
          <div className="space-y-6">
            ...
            <div className="pt-2">
              <Link
                href={href}
                className="inline-flex items-center button-primary group"
              >
        ...
        >
          <div className="relative">
            <div className="relative overflow-hidden rounded-xl shadow-xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-primary/20 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end">
                <div className="p-6">
            ...
            {/* Badge de qualité */}
            <div className="absolute -top-4 -right-4 bg-accent-500 text-white text-xs font-bold px-3 py-2 rounded-full shadow-lg">
              Premium
            </div>
          </div>
        </ClientMotionDiv>
